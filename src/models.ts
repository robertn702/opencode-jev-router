...
function profile(id: string, name: string, supportedEfforts: Effort[]): ModelProfile {
  return Object.freeze({ id, name, supportedEfforts: Object.freeze(supportedEfforts),
